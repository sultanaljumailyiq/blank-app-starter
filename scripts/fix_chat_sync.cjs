...
const runMigration = async () => {
    ...
    try {
        ...
        const sql = `
-- Fix the RPC to grab the newest conversation so both clinic and lab look at the same channel
...
BEGIN
    ...
    -- CHANGED TO id DESC to align with get_lab_conversations which uses max(id)
...
$$ LANGUAGE plpgsql SECURITY DEFINER;
        ...
        console.log('✨ Success! RPC Sync Fixed.');
